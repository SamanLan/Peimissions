...
public final class PermissionsUtils {
     ...
     * @return 返回 {@link PermissionsUtils} 自身，进行链式调用
     */
    public PermissionsUtils getPermissions(int requestCode, String... permissions) {
        getPermissionsWithTips(requestCode, null, permissions);
        return this;
    }
     ...
     * @return 返回 {@link PermissionsUtils} 自身，进行链式调用
     */
    public PermissionsUtils getPermissionsWithTips(int requestCode, String[] tips, String... permissions) {
